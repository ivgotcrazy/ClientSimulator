...
typedef enum {
	...
	BDB_RECNO=3,
	BDB_QUEUE=4,
	BDB_UNKNOWN=5			/* Figure it out on open. */
} BDBTYPE;
...
struct __db {
	...
	BDBTYPE	 type;			/* DB access method type. */
