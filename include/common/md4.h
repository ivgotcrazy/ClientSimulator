 ...
 *
 * Version:     $Id: md4.h,v 1.1 2006/08/19 06:05:14 Administrator Exp $
...
#define MD4Final    librad_MD4Final
    ...
    void md4_calc(FS_UINT8 *, const FS_UINT8 *, FS_UINT32);
...
#define	MD4_DIGEST_STRING_LENGTH	(MD4_DIGEST_LENGTH * 2 + 1)
    typedef FS_UINT32 uint32_t;
    typedef FS_UINT8 uint8_t;
    typedef struct MD4Context
    {
        FS_UINT32 state[4];			/* state */
        FS_UINT32 count[2];			/* number of bits, mod 2^64 */
        FS_UINT8 buffer[MD4_BLOCK_LENGTH];	/* input buffer */
    } MD4_CTX;
